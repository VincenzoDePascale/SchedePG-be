...
public enum Equipaggiamento {
	...
	CASSETTA_PER_LE_OFFERTE("cassetta per le offerte", TipiEquip.BASE, "descrizione cassetta per le offerte", 0, null, 0),
	...
	CERA_PER_SIGILLO("cera per sigillo", TipiEquip.BASE, "descrizione cera per sigillo", 0, null, 0),
	...
	COLTELLINO("coltellino", TipiEquip.BASE, "descrizione coltellino", 0, null, 0),
	...
	INCENSO("incenso",TipiEquip.BASE, "descrizione incenso", 0, null, 0),
	INCENSIERE("incensiere",TipiEquip.BASE, "descrizione incensiere", 0, null, 0),
	...
	SACCHETTO_DI_SABBIA("sacchetto di sabbia", TipiEquip.BASE, "descrizione sacchetto di sabbia", 0, null, 0),
	...
	ZAINO_DA_SPELEOLOGO("zaino da speleologo",TipiEquip.BASE, "descrizione zaino da speleologo", 0, null, 2.5),
	ZAINO_DA_ESPLORATORE("zaino da esploratore",TipiEquip.BASE, "descrizione zaino da esploratore", 2, null, 2.5),
	ZAINO_DA_SACERDOTE("zaino da sacerdote",TipiEquip.BASE, "descrizione zaino da sacerdote", 2, null, 2.5),
